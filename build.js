...
const jobs = [
  ...
  const getJobPositionLocation = function (arrayOfJobs){
      let newArrayJobs = []
          for (let i= 0; i<arrayOfJobs.length; i++ ){
          newArrayJobs.push(arrayOfJobs[i].location.concat(",", arrayOfJobs[i].title))
      }
      return newArrayJobs
  }
console.log(getJobPositionLocation(jobs))